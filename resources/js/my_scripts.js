...
function loadStatsPage(){
	var table = document.getElementById("stats_table");//Retrieve our table element
		...
		//Keeps track of our column index
		wins.innerHTML = 0;
	 losses.innerHTML = 0;
		var homeScore;
		...
		{//Outer for loop iterates over each row
			...
			if(homeScore > parseInt(table.rows[row_counter].cells[3].innerHTML)){
		...
		*/
		function loadPlayersPage(){
			...
			//	x.value = x.value  + "\r\n" + this.value;
				...
				document.getElementById("player_selector").href="#";
				//var element = document.getElementById("player_selector").appendChild(x);
				//element.onclick =	switchPlayers(player[i]);
